...
export const learningSubjects = [
  ...
  { id: '02', bookId: '02', title: '데이터 이해와 활용', description: '데이터를 정확히 기록하고 분석해 업무 판단에 사용합니다.' },
  ...
  { id: '05-01', bookId: '05', title: 'IT 비즈니스', description: 'IT로 어떤 업무 문제를 해결할지 정하고 개선 효과를 확인합니다.' },
