...
articleGroup.innerHTML=`<button aria-expanded="false" aria-controls="site-article"><span>심화수업</span>${arrow}</button><div id="site-article" class="site-submenu" hidden><a href="${url('article/')}">전체 심화수업</a>${subjectMenu('article')}</div>`;
