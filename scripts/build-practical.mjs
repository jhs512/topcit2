...
const note = '교재 개념을 먼저 설명하고 실무 판단과 가상 예시로 연결한 자체 해설입니다. 각 항목의 관련 교재 내용에서 단원과 PDF 페이지를 확인할 수 있습니다. 20개 노트는 교재 전체 요약이나 시험 중요도 순위가 아니며, 주제 끝의 추가 학습 내용도 함께 확인하세요.';
