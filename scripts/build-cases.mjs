...
await save('shared/case-catalog.mjs', `// Generated by scripts/build-cases.mjs from the available case collection.\nexport const caseSubjects = ${JSON.stringify([{ id: '05', title: subject }], null, 2)};\n`);
