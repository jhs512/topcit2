...
- **실제 사례 4편(BIZ-11·01·05·07), 가상 이야기 7편**으로 구성한다. 실제 사례의 사건·수치는 아래 1차 출처에 한정하고 창작 대화를 넣지 않는다. 가상 편의 회사·인물·대화·수치는 설정임을 표시한다.
...
사용자의 전체 문장 개선 요청에 따라 일반 원리의 생략된 대상과 행동을 풀어 쓰고, 사례별 교훈은 본문의 실제 선택과 예상 결과로 구체화했다. 사건·수치·출처·ID는 유지했다.
