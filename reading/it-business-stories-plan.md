...
| 학생용 결과물 | `reading/it-business-stories.md` | 아래 BIZ-11, BIZ-01–BIZ-10을 각각 완결된 산문 한 편으로 구현한다. |

**유지보수:** 개념·핵심 문장·이야기 방향을 바꿀 때는 기획을 먼저 수정하고 같은 ID의 산문에 반영한다. ID는 유지하며, 산문만 고쳐 기획과 다른 주장을 만들지 않는다. 기획과 산문의 의미 일치는 사람이 검토하고, 원고 구획·필수 항목·순서는 공통 스키마 검증기로 검사한다.

## 2. 독자와 범위

- 독자: 프로그램은 만들 수 있지만 기업이 왜 그 프로그램을 요구하는지는 아직 낯선 학생.
- 목표: 용어를 외우기 전에 사람의 목표, 당시 선택의 이유, 놓친 조건과 결과를 읽고 개념의 필요성을 이해한다.
- 중심 범위: 교재 I–VII장의 목표·전략·계획·도입·프로세스·서비스·성과평가. 11편은 이 흐름의 입문용 선정이며 전권 요약이나 출제 빈도 순위가 아니다.
...
- **원리 근거:** [I.01 비즈니스와 IT의 연계 · PDF 20쪽](https://jhs512.github.io/topcit2/textbook/05/#page-020)
...
- **표현 경계:** CIA가 아닌 FBI 사건이다. 막연한 전산화 지시 한마디가 있었다고 창작하지 않는다. 1억 7천만 달러는 OIG가 설명한 개발사업 규모로 표현하며 전액 확정 손실이라고 단정하지 않는다.
...
**필수 사전 소개 — 본문 직전에 선택 구획 ‘들어가기 전에’로 제시한다.**

아래 두 설명 문단을 원고의 선택 구획 `### 들어가기 전에`에 둔다. 공통 렌더러가 배경·테두리·여백이 있는 도입 박스로 표시하고 다음 본문은 영역 밖에 둔다. 마지막 판단 구획의 제목은 ‘결론’이다.
...
- **원리 근거:** [II.03 SWOT 분석 · PDF 38쪽](https://jhs512.github.io/topcit2/textbook/05/#page-038)
...
- **원리 근거:** [III.02 IT 거버넌스의 개념 · PDF 42쪽](https://jhs512.github.io/topcit2/textbook/05/#page-042)
...
- **원리 근거:** [III.04 ISP 구축절차 · PDF 48쪽](https://jhs512.github.io/topcit2/textbook/05/#page-048)
...
- **원리 근거:** [IV.04 아웃소싱 도입 프로세스·고려사항 · PDF 58쪽](https://jhs512.github.io/topcit2/textbook/05/#page-058)
...
- **원리 근거:** [V.05 PI의 수행절차 · PDF 71쪽](https://jhs512.github.io/topcit2/textbook/05/#page-071)
...
- **원리 근거:** [VI.01 ERP의 구성·구축절차 · PDF 83쪽](https://jhs512.github.io/topcit2/textbook/05/#page-083)
...
- **원리 근거:** [VI.01 SCM의 개념·기능 · PDF 86쪽](https://jhs512.github.io/topcit2/textbook/05/#page-086)
...
- **원리 근거:** [VI.01 CRM 분류 비교·고객 접점 · PDF 89쪽](https://jhs512.github.io/topcit2/textbook/05/#page-089)
...
- **원리 근거:** [VII.05 KPI의 개요·수립 절차 · PDF 111쪽](https://jhs512.github.io/topcit2/textbook/05/#page-111)
...
2026-09-16 열람. 아래 링크는 사례의 공시·조사 문서이며 교재 참고 링크와 구분한다. 교재 원문 링크는 앞 절의 자체 HTML 교재만 사용한다.
...
각 편은 제목·사례 유형·교재 개념을 메타데이터로 보존하고, **이 글에서 배우는 교훈 → 들어가기 전에(선택) → 본문 → 결론** 순서로 구성한다. 결론은 공통 박스로 표시하고 출처는 별도 참고 영역에 둔다. [사례 작성 형식](CASE-AUTHORING.md)에 따라 Markdown을 작성하며 스키마 검증과 공통 렌더러로 생성한다. 교훈은 추상적인 문장 → 근거 → 구체적인 문장 순서의 필수 필드로 작성한다. 두 문장은 서로 달라야 하며, ID와 두 문장을 기획과 결과에서 일치시킨다.
...
2026-09-16에 교재 05의 카탈로그 source, 목차(PDF 8–15쪽), I–VII장 학습목표(PDF 16·29·40·51·60·78·105쪽), 각 주제의 관련 본문을 확인했다. 전략 연계 20쪽, 전략·환경분석 31–38쪽, 거버넌스 42–44쪽, ISP 47–49쪽, 아웃소싱 57–59쪽, BPR·PI 69–71쪽, ERP 82–84쪽, SCM 85–87쪽, CRM 87–90쪽, BSC·KPI 108–111쪽을 바탕으로 추상적인 문장을 정리했다.

기존 10개 교훈은 구체적인 문장으로 유지한다. 도입·본문·결론·참고와 사건 출처는 그대로 보존한다. CRM의 고객 정보 단절 문장은 BIZ-09에서만 사용한다. 스키마 v2에서 두 문장과 원리 근거의 누락·빈값·순서·중복을 검사하고, 생성 전에 근거 페이지가 교재 원본에 있는지 확인한다.

두 문장과 원리 근거는 제목과 함께 하나의 공통 교훈 박스 안에 둔다. 학생 화면에는 내부 필드명을 표시하지 않고 원리 문장을 바로 보여 준다. 사례 적용 문장 앞에는 “구체적으로는”을 붙이되 승인된 문장 자체는 유지한다. 이 배치는 공통 렌더러와 10편 전체 PC·모바일 DOM·경계 검사로 유지한다.
