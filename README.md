...
[사례 모음 열기](cases/) → 과목 선택 → 사례 목록 → 이야기 순서로 읽습니다. 현재 **IT비즈니스와 윤리 10편(실제 사례 3편·가상 사례 7편)**을 제공합니다. 각 사례의 교훈은 교재 원리를 풀어 쓴 **추상적인 문장**과 사례에 적용한 **구체적인 문장**으로 구성하며, 원리의 교재 단원·페이지를 함께 확인할 수 있습니다.
